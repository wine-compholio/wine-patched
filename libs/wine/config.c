...
wine_patch_data[] =
{
    ...
    { "Bruno Jesus", "dmstyle: Return the correct variable.", 1 },
    ...
    { "Michael Müller", "amstream: Correctly check return values in IAMMultiMediaStreamImpl_Initialize (Coverity).", 1 },
    ...
    { "Michael Müller", "kernel32: Correctly check for an empty short filename in GetShortPathNameW (Coverity).", 1 },
    ...
    { "Michael Müller", "mshtml: Do not crash on null window in get_frame_by_name.", 1 },
    ...
    { "Michael Müller", "wbemprox: Treat \\\\r as whitespace.", 1 },
    ...
    { "Sebastian Lackner", "Revert \"wined3d: Allow specifying a different depth stencil location.\".", 1 },
    ...
    { "Sebastian Lackner", "iphlpapi: Add stub for ConvertInterfaceLuidToGuid.", 1 },
    ...
    { "Sebastian Lackner", "winedbg: Also output system information to the terminal, not only to dialog.", 1 },
