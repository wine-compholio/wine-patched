...
wine_patch_data[] =
{
    ...
    { "Michael Müller", "ntdll: Open current working directory with FILE_TRAVERSE access.", 1 },
    ...
    { "Sebastian Lackner", "server: Allow to create win23 prefix when directory already exists.", 1 },
