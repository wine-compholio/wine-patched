...
wine_patch_data[] =
{
    ...
    { "Bruno Jesus", "krnl386.exe16: Skip invalid entries in GetPrivateProfileString16.", 1 },
    ...
    { "Sebastian Lackner", "kernel32/tests: Add tests for committing stack guard pages.", 2 },
    ...
    { "Sebastian Lackner", "ntdll: Commit new guard pages in virtual_handle_stack_fault.", 1 },
    ...
    { "Sebastian Lackner", "wine.inf: Add information for delayed end of DST in Europe/Istanbul.", 1 },
