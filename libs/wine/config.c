...
wine_patch_data[] =
{
    ...
    { "Matteo Bruni", "wined3d: Don't use the builtin FFP uniform for the normal matrix.", 1 },
    ...
    { "Pierre Schweitzer", "setupapi: Implement SetupOpenLog(), SetupLogErrorA(), SetupLogErrorW(), SetupCloseLog().", 1 },
    ...
    { "Sebastian Lackner", "gdiplus: Add missing returns in initialize_decoder_wic (Coverity).", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Fix check for end_frame in RtlUnwindEx on x86_64.", 3 },
    ...
    { "Sebastian Lackner", "user32: Fix padding in user_thread_info structure.", 1 },
    ...
    { "Stefan Dösinger", "ddraw: Update the palette before presents to the NULL window.", 1 },
