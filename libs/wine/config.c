...
wine_patch_data[] =
{
    ...
    { "Dmitry Timoshkov", "msi: Add a trace to msi_get_property.", 1 },
    { "Dmitry Timoshkov", "msi: Correctly parse double quotes in the token value.", 1 },
    ...
    { "Michael Müller", "advapi32: Mark some functions as hotpatchable.", 1 },
    ...
    { "Michael Müller", "comctl32: Add implementation for LoadIconMetric.", 1 },
    { "Michael Müller", "comctl32: Add semi-stub implementation for LoadIconWithScaleDown.", 1 },
    ...
    { "Michael Müller", "gdi32: Mark some functions as hotpatchable.", 1 },
    ...
    { "Michael Müller", "kernel32: Mark WritePrivateProfileStringA as hotpatchable.", 1 },
    ...
    { "Michael Müller", "user32: Ignore sizes passed in WM_SIZE for edit control.", 1 },
    ...
    { "Michael Müller", "ws2_32: Implement InetPtonA/W.", 1 },
    ...
    { "Sebastian Lackner", "msvcrt: Pass cookie reference to msvcrt_local_unwind4 instead of value.", 1 },
