...
wine_patch_data[] =
{
    ...
    { "Gerald Pfeifer", "wordpad: Check for array index before using it in registry_set_filelist.", 1 },
    ...
    { "Joachim Priesner", "ws2_32: WS_get_local_ips: Fix ordering of IP addresses by metric if two addresses have the same metric.", 2 },
    ...
    { "Michael Müller", "api-ms-win-core-datetime-l1-1-0: Add dll.", 1 },
    { "Michael Müller", "api-ms-win-core-datetime-l1-1-1: Add stub dll.", 1 },
    { "Michael Müller", "api-ms-win-core-fibers-l1-1-0: Add dll.", 1 },
    { "Michael Müller", "api-ms-win-core-fibers-l1-1-1: Add dll.", 1 },
    { "Michael Müller", "api-ms-win-core-file-l2-1-0: Add dll.", 1 },
    { "Michael Müller", "api-ms-win-core-localization-l1-2-1: Add dll.", 1 },
    { "Michael Müller", "api-ms-win-core-winrt-error-l1-1-1: Add stub dll.", 1 },
    { "Michael Müller", "api-ms-win-core-winrt-l1-1-0: Add stub dll.", 1 },
    { "Michael Müller", "api-ms-win-core-xstate-l2-1-0: Add stub dll.", 1 },
    ...
    { "Ron Yorston", "msvcrt: Fix passing of explicit environment to spawn/exec calls.", 1 },
    ...
    { "Sebastian Lackner", "wintrust: Reset data->pWintrustData->u.pFile->hFile after closing handle.", 1 },
    { "Sebastian Lackner", "ws2_32/tests: Fix several copy and paste errors.", 1 },
    ...
    { "Sebastian Lackner", "ws2_32: Improve implementation of get_poll_results.", 1 },
