...
wine_patch_data[] =
{
    ...
    { "Christian Costa", "d3dxof: Use straight assignement instead of using memcpy with hardcoded size.", 1 },
    ...
    { "Sebastian Lackner", "server: Fall back to global key state when thread doesn't have a queue.", 1 },
