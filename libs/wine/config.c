...
wine_patch_data[] =
{
    ...
    { "Michael Müller", "dsound: Respect return value of callback in DirectSoundEnumerateA/W.", 1 },
    ...
    { "Michael Müller", "wined3d: Do not set DDCAPS_ALIGNBOUNDARYSRC as cap for ddraw.", 1 },
    ...
    { "Sebastian Lackner", "include: Avoid duplicate definition of REFERENCE_TIME.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Remove memory limitation to 32GB on 64-bit by growing heap dynamically.", 1 },
