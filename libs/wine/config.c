...
wine_patch_data[] =
{
    ...
    { "Christian Costa", "d3dx9_36: Fix d3dx9_skin_info_ConvertToIndexedBlendedMesh stub.", 1 },
    ...
    { "Christian Costa", "windowscodecs: Fix init of LONGLONG variable with a negative value in TGA decoder.", 1 },
    ...
    { "Jonathan Vollebregt", "reg: Add check for multiple backslashes at the end of the key.", 1 },
    { "Jonathan Vollebregt", "reg: Add path/key conversion functions.", 1 },
    { "Jonathan Vollebregt", "reg: Add sane_path function to do preliniary key validation.", 1 },
    { "Jonathan Vollebregt", "reg: Add system error printing function.", 1 },
    { "Jonathan Vollebregt", "reg: Add wchar/raw data conversion functions.", 1 },
    { "Jonathan Vollebregt", "reg: Add wchar/type conversion functions.", 1 },
    { "Jonathan Vollebregt", "reg: Clean up reg_add.", 1 },
    { "Jonathan Vollebregt", "reg: Clean up reg_delete.", 1 },
    ...
    { "Michael Müller", "gdi32: Fix arguments for OSMesaMakeCurrent when using 16 bit formats.", 1 },
    ...
    { "Michael Müller", "winedevice: Call DriverUnload function when unloading a driver.", 1 },
    ...
    { "Sebastian Lackner", "include: Remove several duplicate definitions from ntdef.h.", 1 },
    ...
    { "Sebastian Lackner", "ntdll/tests: Add tests for NtQueryLicenseKey.", 1 },
    { "Sebastian Lackner", "ntdll/tests: Add tests for RtlIpv4StringToAddressExA.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Implement [Nt|Zw]QueryLicenseValue.", 1 },
    { "Sebastian Lackner", "ntdll: Implement additional threadpool work item functions.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Implement threadpool, cleanup group and callback instance functions.", 2 },
    ...
    { "Sebastian Lackner", "ntdll: Try to handle write-watches while we're on the signal stack.", 2 },
    ...
    { "Sebastian Lackner", "shell32: Various style fixes and memory leak fix in IApplicationAssociationRegistration.", 1 },
    ...
    { "Sebastian Lackner", "slc: Implement SLGetWindowsInformationDWORD.", 1 },
    ...
    { "Sebastian Lackner", "winebuild: Do not access memory below ESP when restoring thread contexts.", 1 },
    { "Sebastian Lackner", "winecfg: Add checkbox to enable/disable vaapi GPU decoder.", 1 },
    { "Sebastian Lackner", "winecfg: Add library override instead of closing winecfg when pressing ENTER.", 1 },
    ...
    { "Sebastian Lackner", "winex11: Only enable XInput2 cursor warp workaround if necessary.", 1 },
    { "Sebastian Lackner", "ws2_32: Avoid race-condition with write watches in WS2_async_accept.", 1 },
