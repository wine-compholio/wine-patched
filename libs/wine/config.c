...
wine_patch_data[] =
{
    ...
    { "Jacek Caban", "mshtml: Avoid crash when trying to bind event scripts to window.", 1 },
    ...
    { "Michael Müller", "wbemprox: Allow connecting to localhost.", 1 },
    ...
    { "Sebastian Lackner", "kernel32/tests: Add tests for deleting readonly files with NtCreateFile.", 1 },
    ...
    { "Sebastian Lackner", "msxml3: Add a missing break (Coverity).", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Add stub for WinSqmIsOptedIn.", 1 },
