...
wine_patch_data[] =
{
    ...
    { "Hugh McMaster", "wineconsole: Add InsertMode to HKCU.", 1 },
    ...
    { "Michael Müller", "configure.ac: Search for otool using AC_CHECK_TOOL.", 1 },
    ...
    { "Michael Müller", "kernel32/tests: Add tests for GetNumaProcessorNode.", 2 },
    ...
    { "Michael Müller", "kernel32: Implement GetNumaProcessorNode.", 2 },
    ...
    { "Sebastian Lackner", "msvcrt: Set *end to NULL when strtod is called with NULL pointer string.", 1 },
