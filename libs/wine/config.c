...
wine_patch_data[] =
{
    ...
    { "Alistair Leslie-Hughes", "d3dcompiler_43: Add D3DCompileFromFile stub.", 3 },
    { "Alistair Leslie-Hughes", "d3dx10_43: Add D3DX10CreateEffectFromFileA/W stubs.", 1 },
    { "Alistair Leslie-Hughes", "d3dx10_43: Add ID3DX10ThreadPump interface.", 1 },
    { "Alistair Leslie-Hughes", "d3dx10_43: Added D3DX10CreateEffectFromMemory stub.", 1 },
    ...
    { "Jarkko Korpi", "wbemprox: Silence repeated \"timeout not supported\" fixme.", 1 },
    ...
    { "Jianqiu Zhang", "ntdll/tests: Add tests for FileRenameInformation.", 1 },
    ...
    { "Martin Storsjo", "api-ms-win-crt-conio-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-convert-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-environment-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-filesystem-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-heap-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-locale-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-math-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-multibyte-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-private-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-process-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-runtime-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-stdio-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-string-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-time-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "api-ms-win-crt-utility-l1-1-0: Add stub dll.", 1 },
    { "Martin Storsjo", "make_specfiles: Use cdecl for stub redirects to ucrtbase, just like to msvcr*.", 1 },
    { "Martin Storsjo", "ucrtbase: Add stub functions for narrow environment.", 1 },
    { "Martin Storsjo", "ucrtbase: Add the new universal CRT DLL.", 1 },
    ...
    { "Michael Müller", "mscoree: Implement _CorValidateImage.", 2 },
    ...
    { "Michael Müller", "server: Increase precision when saving / loading registry modification date.", 1 },
    ...
    { "Michael Müller", "winecfg: Do not overwrite theme each time an item is drawn.", 1 },
    { "Michael Müller", "winecfg: Show unmounted devices and allow changing the device value.", 1 },
    { "Michael Müller", "wineconsole: Forward child process exitcode.", 1 },
    ...
    { "Michael Müller", "winhttp: Raw request headers needs to be terminated using double \\\\r\\\\n.", 1 },
    { "Michael Müller", "winhttp: Remove unused variable in read_reply().", 1 },
    ...
    { "Michael Müller", "wininet: Disabling proxy should return success when no proxy was enabled.", 1 },
    ...
    { "Qian Hong", "ntdll/tests: Add tests for FileLinkInformation class.", 1 },
    ...
    { "Sebastian Lackner", "d3dcompiler_43: Implement semi-stub for D3DCompile2.", 1 },
    ...
    { "Sebastian Lackner", "ntdll/tests: Add additional tests for FileRenameInformation.", 1 },
    { "Sebastian Lackner", "ntdll/tests: Add tests for FileRenameInformation with nonzero RootDir.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Implement FileRenameInformation support.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Move cookie initialization code from memory management to loader.", 1 },
    ...
    { "Sebastian Lackner", "oleaut32: Fix possible integer overflow in VarR4FromDec.", 1 },
    ...
    { "Sebastian Lackner", "server: Add support for setting file disposition information.", 1 },
    ...
    { "Sebastian Lackner", "server: Fix handling of opening a file with RootDirectory pointing to a file handle.", 3 },
    ...
    { "Sebastian Lackner", "server: Implement support for FileLinkInformation class in NtSetInformationFile.", 1 },
    { "Sebastian Lackner", "server: Introduce a helper function to update the thread_input key state.", 1 },
    { "Sebastian Lackner", "server: Introduce a shadow keystate array to sync keystates only on changes.", 1 },
    ...
    { "Sebastian Lackner", "vcomp: Implement _vcomp_flush and add tests.", 1 },
    ...
    { "Sebastian Lackner", "wined3d: Properly initialize format_flags for surfaces and volumes.", 1 },
    ...
    { "Sebastian Lackner", "wininet: Print the correct function name in ok() messages.", 1 },
    ...
    { "Zhaonan Liang", "include: Add declaration for FILE_LINK_INFORMATION.", 1 },
    { NULL, NULL, 0 }
};
