...
wine_patch_data[] =
{
    ...
    { "Alex Henrie", "riched20: Fix link notification conditions and add tests.", 1 },
    ...
    { "Michael Müller", "advapi32: Implement GetWindowsAccountDomainSid.", 1 },
    ...
    { "Michael Müller", "wininet: Use random names when caching very long urls.", 1 },
    ...
    { "Sebastian Lackner", "configure: Add libunwind configure flag.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Add support for AT_ROUND_TO_PAGE flag in NtMapViewOfSection.", 1 },
