...
wine_patch_data[] =
{
    ...
    { "Andrew Nguyen", "dinput: Allow EnumDevices callback functions with broken calling conventions.", 1 },
    ...
    { "Sebastian Lackner", "server: Do not require SeBackupPrivilege in load_registry and unload_registry.", 1 },
