...
wine_patch_data[] =
{
    ...
    { "Hugh McMaster", "reg: Query all values and subkeys in a specified key.", 3 },
    ...
    { "Michael Müller", "wbemprox/tests: Add tests for ASSOCIATORS queries.", 1 },
    ...
    { "Michael Müller", "wininet: Fix async check in HTTPREQ_ReadFileEx.", 1 },
    { "Michael Müller", "wininet: Handle async mode in HTTPREQ_ReadFile.", 1 },
    ...
    { "Sebastian Lackner", "wininet: Remove unused 'sync' argument from HTTPREQ_Read.", 1 },
    ...
    { "Sergey Isakov", "wined3d: Fix typo in TRACE message.", 1 },
