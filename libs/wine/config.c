...
wine_patch_data[] =
{
    ...
    { "Alistair Leslie-Hughes", "dwmapi: Add DwmUpdateThumbnailProperties stub.", 1 },
    ...
    { "Erich E. Hoover", "wineps.drv: Add support for PostScript Format 1 glyph names.", 1 },
    { "Erich E. Hoover", "wineps.drv: Add support for PostScript Format 2 custom glyph names.", 1 },
    { "Erich E. Hoover", "wineps.drv: Add support for PostScript Format 2 standard glyph names.", 1 },
    ...
    { "Michael Müller", "advpack: Translate flags in LaunchINFSection.", 1 },
    ...
    { "Michael Müller", "kernel32: Implement Set/GetThreadGroupAffinity.", 1 },
    ...
    { "Michael Müller", "ntdll: Implement ThreadGroupInformation class.", 1 },
    ...
    { "Michael Müller", "wbemprox: Set bios name in Win32_BIOS.", 1 },
    ...
    { "Samuel Kim", "comctl32: fix buttons becoming unthemed when pressed/released Fixes 37584.", 1 },
    ...
    { "Sebastian Lackner", "netprofm: Fix possible memory leak in init_networks (Coverity).", 1 },
    ...
    { "Sebastian Lackner", "opencl: Avoid deprecation warning for OpenCL 1.2 APIs.", 1 },
    ...
    { "Sebastian Lackner", "server: Switch back to server dir when open_fd fails.", 1 },
