...
wine_patch_data[] =
{
    ...
    { "Christian Costa", "wined3d: Use proper color key type define when calling wined3d_texture_set_color_key.", 1 },
    ...
    { "Heiko Przybyl", "ws2_32: Call SetLastError for successful WSARecv.", 1 },
    ...
    { "Michael Müller", "nvcuda: First implementation.", 1 },
    { "Michael Müller", "nvcuda: Properly wrap undocumented 'ContextStorage' interface and add tests.", 1 },
    { "Michael Müller", "nvcuvid: First implementation.", 1 },
    ...
    { "Sebastian Lackner", "dinput: Ensure X11 input events are handled even without explicit message loop.", 1 },
    ...
    { "Sebastian Lackner", "slc/tests: Add tests for SLGetWindowsInformationDWORD.", 1 },
    ...
    { "Sebastian Lackner", "wininet: Fix handling of subdirectory in FtpFindFirstFile.", 1 },
