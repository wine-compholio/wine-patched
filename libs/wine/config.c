...
wine_patch_data[] =
{
    ...
    { "Damjan Jovanovic", "winex11.drv: Only send WM_DROPFILES when OLE dnd fails.", 1 },
    { "Dan Kegel", "kernel32: ConnectNamedPort should return FALSE and set ERROR_PIPE_CONNECTED on success in overlapped mode.", 1 },
    { "Dan Kegel", "vcomp/tests: Add initial tests for _vcomp_fork.", 1 },
    { "Dan Kegel", "vcomp: Implement stub for _vcomp_fork.", 1 },
    ...
    { "Dmitry Timoshkov", "gdiplus: Forward GIF encoder requests to windowscodecs.", 1 },
    ...
    { "Erich E. Hoover", "ntoskrnl.exe: Improve IoGetDeviceObjectPointer stub to appease SecuROM 5.x.", 1 },
    ...
    { "Hugh McMaster", "kernel32: Set console InsertMode immediately.", 1 },
    { "Hugh McMaster", "wineconsole: Add InsertMode to the user dialog.", 1 },
    { "Hugh McMaster", "wineconsole: Improve semantics of some poorly-worded resource strings.", 1 },
    { "Hugh McMaster", "wineconsole: Rearrange user dialog to make space for InsertMode checkbox.", 1 },
    ...
    { "Jarkko Korpi", "widl: Increase buffer size in typegen.c.", 1 },
    ...
    { "Michael Müller", "configure.ac: Remove check for strength-reduce bug.", 1 },
    { "Michael Müller", "configure.ac: Search for otool using AC_CHECK_TOOL.", 2 },
    ...
    { "Michael Müller", "wined3d: Use pci and memory information from MESA if possible.", 1 },
    ...
    { "Sebastian Lackner", "Revert \"ntdll: Randomize security cookie when available.\".", 1 },
    ...
    { "Sebastian Lackner", "dwrite: Avoid dereferencing NULL pointer for fonts without VDMX.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Fix incorrect assignment in assert statement (Coverity).", 1 },
    ...
    { "Sebastian Lackner", "vcomp/tests: Add tests for _vcomp_for_static_init.", 1 },
    { "Sebastian Lackner", "vcomp/tests: Add tests for _vcomp_for_static_simple_init.", 1 },
    { "Sebastian Lackner", "vcomp: Add basic worker thread infrastructure.", 1 },
    { "Sebastian Lackner", "vcomp: Implement _vcomp_barrier.", 1 },
    { "Sebastian Lackner", "vcomp: Implement _vcomp_for_dynamic_init and _vcomp_for_dynamic_next and add tests.", 1 },
    { "Sebastian Lackner", "vcomp: Implement _vcomp_for_static_init.", 1 },
    { "Sebastian Lackner", "vcomp: Implement _vcomp_for_static_simple_init and _vcomp_for_static_end.", 1 },
    { "Sebastian Lackner", "vcomp: Implement _vcomp_sections_init and _vcomp_sections_next and add tests.", 1 },
    { "Sebastian Lackner", "vcomp: Implement omp_in_parallel.", 1 },
    ...
    { "Sebastian Lackner", "ws2_32: Fix uninitialized memory access in do_poll (Coverity).", 1 },
