...
wine_patch_data[] =
{
    ...
    { "Andrew Cook", "ntdll: Return STATUS_SUCCESS from SetInformationJobObject.", 1 },
    { "Andrew Cook", "server: Implement JOB_OBJECT_LIMIT_KILL_ON_JOB_CLOSE.", 1 },
    { "Andrew Cook", "server: Implement remaining wineserver calls for job objects.", 1 },
    ...
    { "Michael Müller", "ws2_32: Don't return an error in WS_select when EINTR happens during timeout.", 1 },
    { "Mikael Ståldal", "wiaservc: Implement IWiaDevMgr::EnumDeviceInfo by returning an empty enumeration of devices.", 1 },
    { "Nikos Mavrogiannopoulos", "schannel_gnutls: when calling pgnutls_server_name_set ensure that the values are sane.", 1 },
    ...
    { "Sebastian Lackner", "Revert \"advapi: Don't use CreateFile when opening file with possibly empty DACL.\".", 1 },
    { "Sebastian Lackner", "Revert \"server: Make directory DACL entries inheritable.\".", 1 },
    ...
    { "Sebastian Lackner", "kernel32: Add stubs for Power{Set,Clear}Request.", 1 },
    { "Sebastian Lackner", "kernel32: Add winediag message to show warning, that this isn't vanilla wine.", 1 },
    { "Sebastian Lackner", "kernel32: Fix calculation of returned buffer in get_registry_locale_info.", 1 },
    ...
    { "Sebastian Lackner", "ntoskrnl: Avoid repeated FIXME messages in PsLookupProcessByProcessId.", 1 },
    ...
    { "Sebastian Lackner", "user32: Move key_state cache into separate structure.", 1 },
    ...
    { "Sebastian Lackner", "winex11: Allow NULL pointer as keystate in X11DRV_ToUnicodeEx.", 1 },
    ...
    { "Stas Cymbalov", "dsound: Fix angle to sound source calculation.", 1 },
