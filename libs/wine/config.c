...
wine_patch_data[] =
{
    ...
    { "Alex Henrie", "dpvoice/tests: Add GetCompressionTypes tests.", 1 },
    { "Alex Henrie", "dpvoice: Turn GetCompressionTypes into a semi-stub.", 1 },
    ...
    { "Erich E. Hoover", "ntdll: Fix expected IOCTL_DVD_READ_STRUCTURE expected output size.", 1 },
    ...
    { "Michael Müller", "wined3d: Add support for DXTn software decoding through libtxc_dxtn.", 2 },
    ...
    { "Sebastian Lackner", "ntdll: Fix check for end_frame in RtlUnwindEx on x86_64.", 1 },
