...
wine_patch_data[] =
{
    ...
    { "Alistair Leslie-Hughes", "d3dx9_36: Add D3DXTessellateNPatches stub.", 2 },
    ...
    { "Martin Storsjo", "ntdll: Handle partial image load config structs.", 3 },
    ...
    { "Sebastian Lackner", "dbghelp: Implement UnDecorateSymbolNameW.", 1 },
    ...
    { "Sebastian Lackner", "ntdll/tests: Add tests for ThreadQuerySetWin32StartAddress info class.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Implement ThreadQuerySetWin32StartAddress info class in NtQueryInformationThread.", 1 },
    { "Sebastian Lackner", "ntdll: Implement ThreadQuerySetWin32StartAddress info class in NtSetInformationThread.", 2 },
    ...
    { "Sebastian Lackner", "ntdll: Mark newly spawned worker threads as busy to avoid problems with long-running tasks.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Validate SecurityCookie pointer before dereferencing.", 1 },
    ...
    { "Sebastian Lackner", "server: Use a separate wineserver call to fetch thread times.", 1 },
    ...
    { "Sebastian Lackner", "vcomp/tests: Add tests for _vcomp_for_dynamic_init.", 1 },
    { "Sebastian Lackner", "vcomp: Implement _vcomp_for_dynamic_init and _vcomp_for_dynamic_next.", 1 },
    ...
    { "Sebastian Lackner", "wineconsole: Consistently return nonzero exitcode on error.", 1 },
