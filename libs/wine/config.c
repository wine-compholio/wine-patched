...
wine_patch_data[] =
{
    ...
    { "Józef Kucia", "wined3d: Silence false FIXME message.", 1 },
    ...
    { "Sebastian Lackner", "comctl32: Avoid misleading indentation warnings.", 1 },
    ...
    { "Sebastian Lackner", "dwrite/tests: Avoid misleading indentation warnings.", 1 },
    ...
    { "Sebastian Lackner", "mshtml: Avoid misleading indentation warnings.", 1 },
    { "Sebastian Lackner", "msvcirt/tests: Avoid misleading indentation warnings.", 1 },
    ...
    { "Sebastian Lackner", "oleaut32/tests: Avoid misleading indentation warnings.", 1 },
    ...
    { "Sebastian Lackner", "rpcrt4/tests: Avoid misleading indentation warnings.", 1 },
    ...
    { "Sebastian Lackner", "scrrun/tests: Avoid misleading indentation warnings.", 1 },
    ...
    { "Sebastian Lackner", "shell32/tests: Avoid misleading indentation warnings.", 1 },
    ...
    { "Sebastian Lackner", "shlwapi/tests: Avoid misleading indentation warnings.", 1 },
    ...
    { "Sebastian Lackner", "user32/tests: Avoid misleading indentation warnings.", 1 },
    ...
    { "Sebastian Lackner", "winhttp/tests: Avoid misleading indentation warnings.", 1 },
    ...
    { "Sebastian Lackner", "wshom.ocx/tests: Avoid misleading indentation warnings.", 1 },
