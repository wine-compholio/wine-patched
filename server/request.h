...
static const req_handler req_handlers[REQ_NB_REQUESTS] =
{
    ...
    (req_handler)req_get_object_typename,
...
C_ASSERT( FIELD_OFFSET(struct get_object_typename_request, handle) == 12 );
C_ASSERT( sizeof(struct get_object_typename_request) == 16 );
C_ASSERT( FIELD_OFFSET(struct get_object_typename_reply, total) == 8 );
C_ASSERT( sizeof(struct get_object_typename_reply) == 16 );
