...
static void dump_get_object_typename_request( const struct get_object_typename_request *req )
{
    fprintf( stderr, " handle=%04x", req->handle );
}

static void dump_get_object_typename_reply( const struct get_object_typename_reply *req )
{
    fprintf( stderr, " total=%u", req->total );
    dump_varargs_unicode_str( ", typename=", cur_size );
}
...
static const dump_func req_dumpers[REQ_NB_REQUESTS] = {
    ...
    (dump_func)dump_get_object_typename_request,
...
static const dump_func reply_dumpers[REQ_NB_REQUESTS] = {
    ...
    (dump_func)dump_get_object_typename_reply,
    NULL,
